...
<form name="frm" action="man/m_siswa.php?ak=<?php echo $ak; ?>" method="POST">
	<ul class="form-style-1">
		<li>
			<label>Nis</label>
			<input type="text" placeholder="nis" name="nis" value="<?php echo "$nis"; ?>" /></br>
		</li>
		<li>
			<label>Nama</label>
		...
		<li>
			<label>Alamat</label>
			<textarea placeholder="alamat"  name="alamat"> <?php echo "$alm"; ?> </textarea></br>
		</li>
		<li>
			<label>No Telp</label>
			<input placeholder="no telp"  type="text" name="no_telp" value="<?php echo "$no_tlp"; ?>"></br>
		</li>
		<li>
		...
		<li>
			...
			<textarea placeholder="alamat ortu"  name="alamat_ortu"> <?php  echo "$alm_ortu"; ?></textarea></br>
		</li>
		<li>
		...
		<li>
			...
			<input placeholder="password siswa"  type="text" name="password_siswa" value="<?php echo "$pass_siswa"; ?>"> </br>
		</li>
		<li>
			<label>Password Orang Tua</label>
			<input placeholder="password ortu"  type="text" name="password_ortu" value="<?php echo "$pass_ortu"; ?> "></br>
		</li>
		<li>
			<label>Tahun Ajaran</label>
			<input placeholder="tahun ajaran"  type="text" name="ta" value="<?php echo $ta; ?> "></br>
		</li>
		<li>
